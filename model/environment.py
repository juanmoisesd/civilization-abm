"""
Entorno de red social del modelo.
...
def build_small_world(agents, k: int = 4, p: float = 0.1) -> nx.Graph:
    ...
    mapping = {i: agents[i].unique_id for i in range(n)}
